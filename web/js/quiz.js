...
function saveProgress(fase, score, total) {
  ...
  if (!progress[fase] || pct > (progress[fase].pct || 0)) {
  ...
  try {
    ...
    document.getElementById('question-area').innerHTML = `
      <div style="text-align:center;padding:2rem;color:#dc2626">
        ...
        <a href="index.html" style="color:#0e7490;margin-top:1rem;display:inline-block">← Voltar ao mapa</a>
      </div>
    `;
  }
});
...
function mostrarEmBreve() {
  ...
  document.getElementById('question-area').innerHTML = `
    <div style="text-align:center;padding:3rem 1.5rem">
      ...
      <a href="index.html" class="btn btn-primary" style="display:inline-flex;text-decoration:none;max-width:200px;margin:0 auto">
...
function mostrarFaseBloqueada() {
  document.getElementById('question-area').innerHTML = `
    <div style="text-align:center;padding:2.5rem 1.5rem">
      ...
      <a href="index.html" class="btn btn-primary" style="display:inline-flex;text-decoration:none;max-width:220px;margin:0 auto">
...
function renderReport() {
  ...
  // Botões — próxima fase ou voltar ao mapa
  const botoesHtml = temProxima
    ? `<div class="btn-row">
        <button class="btn btn-primary" onclick="irParaProximaFase()">
          <i class="fa-solid fa-chevron-right"></i> Próxima Fase
        </button>
      ...
      <div style="text-align:center;margin-top:0.8rem">
        <a href="index.html" style="font-size:0.8rem;color:#94a3b8;text-decoration:none">
